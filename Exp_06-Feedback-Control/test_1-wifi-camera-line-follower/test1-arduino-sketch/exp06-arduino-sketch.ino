...
void loop() {
    ...
    // We won't be using the distance in this code.
    ...
    robot_status = Serial.readStringUntil('\n');
    ...
    if (robot_status.equals("too_far_right")) {
  
        turn_left();

    // if the user is holding up 4 fingers 
    } else if (robot_status.equals("too_far_left")) {
